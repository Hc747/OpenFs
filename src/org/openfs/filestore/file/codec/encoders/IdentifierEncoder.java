 ...
 * @since 7/2/17
 */
public final class IdentifierEncoder implements ReferenceEncoder<IndexedFile> {

	@Override
	public void encode(IndexedFile reference, ByteBuf buffer) {
		buffer.writeByte(Reference.REFERENCE_IDENTIFIER_OPCODE);
		buffer.writeByte(reference.getIdentifier());
	}
